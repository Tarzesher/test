...
var AutoCompleteComponent = /** @class */ (function () {
    function AutoCompleteComponent() {
        ...
        this.filteredStates = this.stateCtrl.valueChanges.pipe(operators_1.startWith(''), operators_1.map(function (state) { return (state ? _this.filterStates(state) : _this.states.slice()); }));
    }
